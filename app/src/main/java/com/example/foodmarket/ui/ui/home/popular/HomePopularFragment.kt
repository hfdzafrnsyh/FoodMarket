package com.example.foodmarket.ui.ui.home.popular
...
class HomePopularFragment : Fragment() , HomeListAdapter.ItemAdapterClickCallback {
...
//        initDummy()
    ...
    fun showCardListAdapter(){
        ...
        rvPopular.adapter = homeListAdapter
